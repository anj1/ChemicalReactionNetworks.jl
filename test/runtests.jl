...
###
chems = ["CH₄", "O₂", "CO₂", "H₂O"]
print(Reaction([1,2],[1,2],[3,4],[1,2],1.0,0.0,chems))
...
reactions = [Reaction([4,2],[1,1],[1,6],[1,1],k1,0,chems),
            Reaction([1,2],[1,1],[6],[2],k2,0,chems),
            Reaction([4,1],[1,1],[1,3],[2,2],k3,0,chems),
            Reaction([1],[2],[4,6],[1,1],k4,0,chems),
            Reaction([5,3],[2,2],[2],[1],k5,0,chems)]
...
reactions = [Reaction([1,4],[1,2],[5],[2],1.0,1.0,chems),
            ...
            Reaction([5,6],[1,1],[3,4],[1,2],1.0,1e-4,chems)]
